...
const defaultSteps: PlanningStep[] = [
  { id: "dress", title: "Find Wedding Dress", budget: 50000, completed: false, order: 1 },
  { id: "venue", title: "Book Venue", budget: 300000, completed: false, order: 2 },
...
export default function Timeline() {
  ...
  const updateStepBudget = (stepId: string, newBudget: number) => {
    setSteps(steps.map(step => 
      step.id === stepId ? { ...step, budget: newBudget } : step
    ));
  };
  ...
  const deleteStep = (stepId: string) => {
    ...
    toast({
      title: "Step removed",
      description: "Planning step has been deleted from your timeline"
    });
  };
  ...
  const addNewStep = () => {
    if (newStepTitle.trim()) {
      ...
      toast({
        title: "Step added",
        description: "New planning step added to your timeline"
      });
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-foreground">
              {weddingData.yourName} & {weddingData.fianceName}'s Wedding Timeline
            </h1>
        ...
        <div className="space-y-4">
          ...
          {steps.map((step, index) => (
            <Card key={step.id} className="shadow-soft border-0">
              <CardContent className="pt-6">
